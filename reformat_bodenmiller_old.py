...
antibody_panel = pl.read_csv("../../data_bodenmiller/data_bodenmiller/Basel_Zuri_StainingPanel.csv")
...
basel_meta = pl.read_csv("../../data_bodenmiller/data_bodenmiller/Basel_PatientMetadata.csv")
zurich_meta = pl.read_csv("../../data_bodenmiller/data_bodenmiller/Zuri_PatientMetadata.csv")
